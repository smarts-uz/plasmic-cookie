...
import sty from "./PlasmicLogout.module.css"; // plasmic-import: 0uc7sNT1dPI0/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: QY3lEt-wrY6I/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: IXPwMEiTSmDC/icon

createPlasmicElementProxy;

export const PlasmicLogout__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicLogout__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link",
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___5GsRi)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__vlvEq)}
                role={"img"}
              />
            ),
